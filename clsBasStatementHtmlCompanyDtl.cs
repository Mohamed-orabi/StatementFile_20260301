...
//Branch 10
public class clsBasStatementHtmlCompanyDtl : clsBasStatement
{
  ...
  public clsBasStatementHtmlCompanyDtl()
  {
  }
  ...
  private void printDetailCompany(DataRowView pAccRowView)
  {
    ...
    dtlRows = DSstatement.Tables["tStatementDetailTable"].Select("accountno = '" + pAccRowView[mCardaccountno].ToString() + "'"); //accountno
    ...
    valCompTransaction += Convert.ToDecimal(pAccRowView[mClosingbalance].ToString()); //valTransaction;
