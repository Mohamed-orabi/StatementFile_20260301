...
// Branch 16
public class clsStatTxtLblSup : clsBasStatement
{
  ...
  protected int curCardRow = 0, curTotCardRows = 0, numOfErr = 0, totNoOfTransactions = 0, totNoOfTransEmail = 0;
  ...
  protected virtual void printCardFooter()
  {
    ...
    strmWriteCommon.WriteLine(basText.alignmentMiddle("Gem Rewards Opening Balance", 30) + basText.alignmentMiddle("Gem Rewards Earned*", 30) + basText.alignmentMiddle("Gem Rewards Redeemed", 30) + basText.alignmentMiddle("Gem Rewards Closing Balance", 30));
    ...
    if (rewardRows.Length > 0)
    {
      ...
      strmWriteCommon.WriteLine(basText.formatNum(rewardRow[mOpeningbalance], "#0.00;(#0.00)", 30, "M") + basText.formatNum(rewardRow["EARNEDBONUS"], "#0.00;(#0.00)", 30, "M") + basText.formatNum(rewardRow["REDEEMEDBONUS"], "#0.00;(#0.00)", 30, "M") + basText.formatNum(rewardRow[mClosingbalance], "#0.00;(#0.00)", 30, "M"));
    }
    else
    {
  ...
  protected void printStatementSummary()
  {
    ...
    StatSummary.NoOfPages = totNoOfPageStat + totNoOfPageEmailStat;
    StatSummary.NoOfTransactions = totNoOfTransactions + totNoOfTransEmail;
