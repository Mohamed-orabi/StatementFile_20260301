...
public class clsStatTxt_EDBE : clsBasStatement //EDBE-586
    {
    ...
    protected virtual void printHeader()
        ...
        strmWriteCommon.WriteLine(basText.alignmentMiddle(CustomerArabicname, 50));  //
    ...
    protected virtual void printCardFooter()
        ...
        if (isReward)
            ...
            strmWriteCommon.WriteLine(String.Empty);
            strmWriteCommon.WriteLine(String.Empty);
            strmWriteCommon.WriteLine(basText.alignmentMiddle("Reward Open Balance", 35) + basText.alignmentMiddle("Reward Earned Bonus", 35) + basText.alignmentMiddle("Reward Redeemed Bonus", 35) + basText.alignmentMiddle("Reward Closing Balance", 35));
            ...
            if (rewardRows.Length > 0)
                ...
                strmWriteCommon.WriteLine(basText.formatNum(rewardRow[mOpeningbalance], "#0.00;(#0.00)", 35, "M") + basText.formatNum(rewardRow["EARNEDBONUS"], "#0.00;(#0.00)", 35, "M") + basText.formatNum(rewardRow["REDEEMEDBONUS"], "#0.00;(#0.00)", 35, "M") + basText.formatNum(rewardRow[mClosingbalance], "#0.00;(#0.00)", 35, "M"));
                }
            else
                {
    ...
    protected virtual void calcAccountRows()
        ...
        mainRows = DSstatement.Tables["tStatementMasterTable"].Select(accountNoName + " = '" + clsBasValid.validateStr(masterRow[accountNoName]) + "'", "cardstate desc");//ACCOUNTNO
