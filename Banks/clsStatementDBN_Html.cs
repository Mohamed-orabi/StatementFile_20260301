...
public class clsStatementDBN_Html : clsBasStatement
{
    ...
    public string Statement(string pStrFileName, string pBankName, int pBankCode, string pStrFile, DateTime pCurDate, string pStmntType, bool pAppendData)
    {
        ...
        try
        {
            ...
            else if (clsBasFile.getFileWithoutExtn(pStrFileName).StartsWith("DBN_VIP1-2_ClientsEmails"))
            {
    ...
    protected void printHeader()
    {
        ...
        emailStr.Append(@"<tr><td width=""98%"" height=""88""><table id=""table21"" height=""50"" width=""100%"" border=""0"">");// style=""border-collapse: collapse"">
