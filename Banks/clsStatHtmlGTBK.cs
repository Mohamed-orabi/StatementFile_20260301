...
public class clsStatHtmlGTBK : clsBasStatement
    {
        ...
        try
            ...
            foreach (DataRow mRow in DSstatement.Tables["tStatementMasterTable"].Rows)
                ...
                if (prevAccountNo != masterRow[accountNoName].ToString())
                    ...
                    curFileName = "Guaranty Trust Bank " + masterRow[mAccountcurrency].ToString() + " Credit Card Statement " + vCurDate.ToString("MMMM yyyy ") + masterRow[mCardclientname].ToString();
                ...
                emailLabelTmp = "Your Guaranty Trust Bank " + masterRow[mAccountcurrency].ToString() + " Credit Card Statement " + vCurDate.ToString("MMMM yyyy ");
