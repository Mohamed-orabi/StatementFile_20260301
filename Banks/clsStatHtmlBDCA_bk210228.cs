...
public class clsStatHtmlBDCA_bk210228 : clsBasStatement
    {
    ...
    public clsStatHtmlBDCA_bk210228()
        {
        }
    ...
    public string Statement(string pStrFileName, string pBankName, int pBankCode, string pStrFile, DateTime pCurDate, string pStmntType, bool pAppendData, string pReportName)
        ...
        try
            ...
            FillStatementDataSet_SortCardPriority(pBankCode, ""); //DSstatement =  //10); //3
            ...
            foreach (DataRow mRow in DSstatement.Tables["tStatementMasterTable"].Rows)
            {
                ...
                //emailLabelTmp = "Your aiBANK Credit Card Statement " + vCurDate.ToString("MMMM yyyy ");

                //emailLabelTmp = "Banque Du Caire Statement (" + masterRow["CardProduct"].ToString().Trim() + ") For " + currStatementdatefrom.ToString("MMMM") + currStatementdateto.ToString(" yyyy"); // + (strPrimaryCardNo != "" ? "_" + strPrimaryCardNo.Substring(strPrimaryCardNo.Length - 4) : "_");
                ...
                {
                    streamNoEmails.WriteLine(curCustomerName + "|" + curAccountNumber + "|" + curClientID + "|" + " " + "|" + "|Bad Email " + emailTo);
                    noOfBadEmails++;
                    exportRptabp = null;
                    stmtnumber = null;
                    continue;
                ...
                // Start of creating PDF for the customer that have Email only
                {
                    ...
                    stmtpass = strNationalID + strBirthYear;
    ...
    private void SendEmail(string pBody, string pSubject, string pTo)
        ...
        if (valdEmail.isValideEmail(pTo) != "ValidEmail")//!basText.isValideEmail(pTo)
            {
                streamNoEmails.WriteLine(curCustomerName + "|" + curAccountNumber + "|" + curClientID + "|" + pTo + "|" + "|Bad Email");
            noOfBadEmails++;
            return;
            //emailTo = strEmailFrom; //"statement_Program@emp-group.com";
            //emailLabelTmp = emailLabel + " Acc:" + curAccountNumber + " Phone:" + emailRow["mobilephone"].ToString();
            ...
            while (!sndMail.sendEmailAttachPicFile(strEmailFromTmp, pLstTo, pLstCC, pLstBCC, pLstAttachedPic, pLstAttachedFile, pSubject, pBody, clsCnfg.readSetting("SmtpServer")))
                ...
                if (numOfTry > 100)
                    ...
                    streamNoEmails.WriteLine(curCustomerName + "|" + curAccountNumber + "|" + curClientID + "|" + " " + "|" + "|Bad Email");
