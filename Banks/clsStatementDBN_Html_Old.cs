...
public class clsStatementDBN_Html_OLd : clsBasStatement
    {
    ...
    public clsStatementDBN_Html_OLd()
        {
        }
        ...
        try
            ...
            foreach (DataRow mRow in DSstatement.Tables["tStatementMasterTable"].Rows)
                ...
                if (prevAccountNo != masterRow[accountNoName].ToString())
                    ...
                    if (!string.IsNullOrEmpty(emailStr.ToString()) && string.IsNullOrEmpty(emailTo)) //emailStr != string.Empty && emailStr != null  emailTo != string.Empty && emailTo != null
                        {
                        streamNoEmails.WriteLine(curAccountNumber + "|" + curClientID + "|" + emailTo + "|" + emailRow["mobilephone"].ToString() + "|Without Email");
                        noOfWithoutEmails++;
                        emailTo = strEmailFrom; //"statement_Program@emp-group.com";
                        emailLabelTmp = emailLabel + " Acc:" + curAccountNumber + " Phone:" + emailRow["mobilephone"].ToString();
    ...
    protected void printHeader()
        ...
        emailStr.Append(@"<table id=""table18"" width=""99%"" border=""0"" style=""border-collapse: collapse;height:93""><tr><td>");
        emailStr.Append(@"<table id=""table19"" style=""height:82"" width=""100%"" border=""0""><tr><td width=""103"" style=""border-style: outset; border-width: 1px"" height=""20"">");
    ...
    private void SendEmail(string pBody, string pSubject, string pTo)
        ...
        if (valdEmail.isValideEmail(pTo) != "ValidEmail")
            ...
            //else
            //    {
                streamNoEmails.WriteLine(curAccountNumber + "|" + curClientID + "|" + pTo + "|" + emailRow["mobilephone"].ToString() + "|Bad Email");
                noOfBadEmails++;
        ...
        //streamEmails.WriteLine(curAccountNumber + "|" + curClientID + "|" + pTo + "|" + DateTime.Now.ToString("yyyy/MM/dd HH:mm:ss"));
            ...
            while (!sndMail.sendEmailAttachPic(strEmailFromTmp, pLstTo, pLstCC, pLstBCC, pLstAttachedFile, pSubject, pBody, clsCnfg.readSetting("SmtpServer")))
                ...
                if (numOfTry > 100)
                    ...
                    streamNoEmails.WriteLine(curAccountNumber + "|" + curClientID + "|" + emailTo + "|" + emailRow["mobilephone"].ToString() + "|Bad Email");
            ...
            {
            //clsBasErrors.catchError(ex);
                streamNoEmails.WriteLine(curAccountNumber + "|" + curClientID + "|" + pTo + "|" + emailRow["mobilephone"].ToString() + "|Bad Email " + pTo + " , Err Message >> " + ex.Message + ", Err Desc >> " + ex.InnerException.Message.ToString());
            noOfBadEmails++;
            }
        finally
            {
