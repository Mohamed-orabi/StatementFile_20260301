...
public class clsStatementDBN_PS_Html : clsBasStatement
    {
    ...
    private string emailLabel, strBankLogo, strBankMidBanner, strBankBottomBanner, strADBanner;
    ...
    //private string bottomBanner = @"D:\pC#\ProjData\Statement\DBN Diamond\Banner.jpg";
    private string prvEmail = string.Empty;
    private decimal totTrans = 0;

    public clsStatementDBN_PS_Html()
        {
        }
    ...
    public string Statement(string pStrFileName, string pBankName, int pBankCode, string pStrFile, DateTime pCurDate, string pStmntType, bool pAppendData)
        ...
        try
            ...
            emailLabel = "ParkNShop" + " statement for " + vCurDate.ToString("MM/yyyy"); //"BAI statement for 02/2008"
            ...
            if (isRewardVal)
                ...
                //strSubTableCond = "d.trandescription not in ('Calculated Points','NSHOP_BONUSES')";
                strSubTableCond = "d.trandescription not in ('NSHOP_BONUSES')";
                curRewardCond = rewardCond;
                getReward(pBankCode);
                }
            //if (clsBasFile.getFileWithoutExtn(pStrFileName).StartsWith("DBN_ParkNShop_ClientsEmails"))
            //{
    ...
    protected void printHeader()
        ...
        //emailStr.Append(@"<img border=""0"" src=""cid:" + clsBasFile.getFileFromPath(strBankLogo) + @"""></a><img border='0' src='cid:" + clsBasFile.getFileFromPath(bottomBanner) + @"'></a></td></tr>");// width=""230"" height=""85""
        emailStr.Append(@"<img border=""0"" src=""cid:" + clsBasFile.getFileFromPath(strBankLogo) + @"""></a></a></td></tr>");// width=""230"" height=""85""
        ...
        //emailStr.Append(@"<tr><td width=""98%"" height=""25"">&nbsp;</td></tr><tr><td width=""98%"" height=""48""><table id=""table20"" height=""46"" width=""100%"" border=""0"">");
        emailStr.Append(@"<tr><td width=""98%"" height=""25"">&nbsp;</td></tr><tr><td width=""98%"" height=""48""><table id=""table20"" height=""46"" width=""79%%"" border=""0"">");
        ...
        emailStr.Append(@"<tr><td width=""98%"" height=""88""><table id=""table21"" height=""50"" width=""79%"" border=""0"">");// style=""border-collapse: collapse"">
    ...
    protected void printCardFooter()
        ...
        emailStr.Append(@"<a href=""http://" + strbankWebLink + @""">");
        //emailStr.Append(@"<img border=""0"" src=""cid:" + clsBasFile.getFileFromPath(strBankMidBanner) + @"""></a></td></tr></table><table id=""table26"" width=""79%"" border=""0"">");
        emailStr.Append(@"<img border=""0"" src=""cid:" + clsBasFile.getFileFromPath(strADBanner) + @"""></a></td></tr></table><table id=""table26"" width=""79%"" border=""0"">");
        ...
        if (isRewardVal)
            ...
            if (rewardRows.Length > 0)
                ...
                emailStr.Append(MakeHeaderStr("Loyalty Rewards Opening Balance", false, true));
                //emailStr.Append(@"</td><td align=""middle"">");
                //emailStr.Append(MakeHeaderStr("Qualifying spend this month", true, true);
                emailStr.Append(@"</td><td align=""middle"" width=""200"" style=""border-style: outset; border-width: 1px"">");
                emailStr.Append(MakeHeaderStr("Loyalty Rewards Earned*", false, true));
                emailStr.Append(@"</td><td align=""middle"" width=""200"" style=""border-style: outset; border-width: 1px"">");
                emailStr.Append(MakeHeaderStr("Loyalty Rewards Redeemed", false, true));
                emailStr.Append(@"</td><td align=""middle"" width=""220"" style=""border-style: outset; border-width: 1px"">");
                emailStr.Append(MakeHeaderStr("Loyalty Rewards Closing Balance", false, true));
                emailStr.Append(@"</td></tr>");
    ...
    private void SendEmail(string pBody, string pSubject, string pTo)
        ...
        //streamEmails.WriteLine(curAccountNumber + "|" + curClientID + "|" + pTo + "|" + DateTime.Now.ToString("yyyy/MM/dd HH:mm:ss"));
            ...
            pLstAttachedFile.Add(strADBanner);//strOutputFile@"D:\Web\Email\BAI\Logo.gif"
    ...
    public string ADBanner
        {
        get { return strADBanner; }
        set { strADBanner = value; }
        }// ADBanner
