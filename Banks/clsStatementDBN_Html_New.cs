...
public class clsStatementDBN_Html_New : clsBasStatement
    {
    ...
    private string emailLabel, strBankLogo, strBankMidBanner, strBankBottomBanner, strBankCard, strBankCardGold, strBankCardPlatinum, strRewardImg;
    ...
    public clsStatementDBN_Html_New()
        {
        }
    ...
    public string Statement(string pStrFileName, string pBankName, int pBankCode, string pStrFile, DateTime pCurDate, string pStmntType, bool pAppendData)
        ...
        try
            ...
            //if (clsBasFile.getFileWithoutExtn(pStrFileName).StartsWith("DBN_MasterCard_Credit_ClientsEmails"))
            //    //DBN-3862 mastercard statement label
            //    emailLabel = "Diamond MasterCard Card Statement for " + vCurDate.ToString("MM/yyyy");
            //else
            // DBN-1972 change statement label
            //emailLabel = "Diamond Visa Card Statement for " + vCurDate.ToString("MM/yyyy");
            ...
            //if (clsBasFile.getFileWithoutExtn(pStrFileName).StartsWith("DBN_Credit_ClientsEmails"))
            //    {
            ...
            if (clsBasFile.getFileWithoutExtn(pStrFileName).StartsWith("DBN_Credit_Classic_ClientsEmails"))
                {
                strMainTableCond += " and m.contracttype in " + VIPCondition + " and m.cardproduct in " + ProductCondition + "";
                emailLabel = "Diamond Visa Card Statement for " + vCurDate.ToString("MM/yyyy");
                }
                ...
                {
                strMainTableCond += " and m.contracttype in " + VIPCondition + " and m.cardproduct = '" + ProductCondition + "'";
                emailLabel = "Diamond Visa Card ParkNShop statement for " + vCurDate.ToString("MM/yyyy");
                }
            else if (clsBasFile.getFileWithoutExtn(pStrFileName).StartsWith("DBN_MasterCard_Credit_ClientsEmails"))
                {
                strMainTableCond += " and m.contracttype in " + VIPCondition + " and m.cardproduct in " + ProductCondition + "";
                emailLabel = "Diamond MasterCard Credit Card Statement for " + vCurDate.ToString("MM/yyyy");
                }
            else if (clsBasFile.getFileWithoutExtn(pStrFileName).StartsWith("DBN_Privilege_ClientsEmails"))
                {
                strMainTableCond += " and m.contracttype in " + VIPCondition + " and + m.cardproduct = '" + ProductCondition + "'";
                emailLabel = "Diamond Visa Card Privilege Statement for " + vCurDate.ToString("MM/yyyy");
                }

            //else if (clsBasFile.getFileWithoutExtn(pStrFileName).StartsWith("DBN_Credit_MasterCard_Platinum_ClientsEmails"))
            //    {
            //    strMainTableCond += " m.contracttype in " + VIPCondition;
            //}
            ...
            foreach (DataRow mRow in DSstatement.Tables["tStatementMasterTable"].Rows)
                ...
                if (prevAccountNo != masterRow[accountNoName].ToString())
                    ...
                    if (!string.IsNullOrEmpty(emailStr.ToString()) && !string.IsNullOrEmpty(emailTo)) //emailStr != string.Empty && emailStr != null  emailTo != string.Empty && emailTo != null
                        SendEmail(emailStr.ToString(), "", emailTo);//emailTo
                    if (!string.IsNullOrEmpty(emailStr.ToString()) && string.IsNullOrEmpty(emailTo)) //emailStr != string.Empty && emailStr != null  emailTo != string.Empty && emailTo != null
                        {
                    ...
                    if (curSuppCard != detailRow[dCardno].ToString())
                        ...
                        if (tmpDtlRows.Length > 0)
                            ...
                            if (tmpDtlRows[0][mCardprimary].ToString() == "N" && isValidateCard(tmpDtlRows[0][mCardstate].ToString()))
                                {
                                emailStr.Append(@"<tr><td align=""center"" width=""6%"" height=""20"">");
                                emailStr.Append(MakeHeaderStr("     ", false, false));
                                emailStr.Append(@"</td><td align=""center"" width=""5%"" height=""20"">");
                                emailStr.Append(MakeHeaderStr("     ", false, false));
                                emailStr.Append(@"</td><td align=""center"" width=""19%"" height=""20"">");
    ...
    protected void printHeader()
        ...
        //\MakeEmailStr   MakeHeaderStr   emailStr iatta
        emailStr = new StringBuilder("");
        ...
        emailStr.Append(@"<b><p align=""center"">");
        emailStr.Append(@"Account Statement</p></b>");
        emailStr.Append(@"<p align=""left"">");
        emailStr.Append(@"Statement billing period: " + currStatementdatefrom.ToString("MMMM d") + " – " + currStatementdateto.ToString("MMMM d") + " </p>");
        emailStr.Append(@"<table id=""table15"" width=""100%"" border=""0""><tr><td height=""82"">");
        emailStr.Append(@"<p align=""" + logoAlignmentStr + @""">");
        emailStr.Append(@"<a href=""http://" + strbankWebLink + @""">");
        emailStr.Append(@"<img border=""0"" alt="""" src=""cid:" + clsBasFile.getFileFromPath(strBankLogo) + @"""></a></td></tr>");// width=""230"" height=""85""
        emailStr.Append(@"<tr><td width=""99%"">");
        emailStr.Append(@"<table id=""table18"" width=""99%"" border=""0"" style=""border-collapse: collapse;height:93""><tr><td style=""width: 50%;"">");
        emailStr.Append(@"<table id=""table19"" style=""height:82"" width=""50%"" border=""0""><tr><td width=""103"" style=""border-style: outset; border-width: 1px"" height=""20"">");
        ...
        //emailStr.Append(@"</td></tr></table></td><td><img  border=""0"" alt=""GO To Diamond ! "" src=""cid:" + clsBasFile.getFileFromPath(strBankCard) + @"""></td></tr></table></td></tr>");
        //iatta split master card logo 
        if (masterRow[mCardproduct].ToString() == "MasterCard Platinum Credit")
            {
            emailStr.Append(@"</td></tr></table></td><td><img  border=""0"" alt=""GO To Diamond ! "" src=""cid:" + clsBasFile.getFileFromPath(strBankCardPlatinum) + @"""></td></tr></table></td></tr>");
            }
        else if (masterRow[mCardproduct].ToString() == "MasterCard Gold Credit")
            {
            emailStr.Append(@"</td></tr></table></td><td><img  border=""0"" alt=""GO To Diamond ! "" src=""cid:" + clsBasFile.getFileFromPath(strBankCardGold) + @"""></td></tr></table></td></tr>");
            }
        else
            {
            emailStr.Append(@"</td></tr></table></td><td><img  border=""0"" alt=""GO To Diamond ! "" src=""cid:" + clsBasFile.getFileFromPath(strBankCard) + @"""></td></tr></table></td></tr>");
        ...
        emailStr.Append(@"<tr><td align=""center"" width=""124"" style=""border-style: outset; border-width: 1px"">");
        emailStr.Append(MakeHeaderStr("Credit Limit", false, true));
        emailStr.Append(@"</td><td align=""center"" width=""122"" style=""border-style: outset; border-width: 1px"">");
        emailStr.Append(MakeHeaderStr("Available Limit", false, true));
        emailStr.Append(@"</td><td align=""center"" width=""200"" style=""border-style: outset; border-width: 1px"">");
        //emailStr.Append(MakeHeaderStr("Min. Due Amount", true, true);
        emailStr.Append(MakeHeaderStr("Minimum Payment Now Due", true, true));
        emailStr.Append(@"</td><td align=""center"" width=""220"" style=""border-style: outset; border-width: 1px"">");
        ...
        emailStr.Append(@"</td><td align=""center"" width=""145"" style=""border-style: outset; border-width: 1px"">");
        emailStr.Append(MakeHeaderStr("Over Due Amount", false, true));
        emailStr.Append(@"</td></tr>");
        emailStr.Append(@"<tr><td align=""center"" width=""124"" height=""19"">");
        ...
        emailStr.Append(@"</td><td align=""center"" width=""122"" height=""19"">");
        ...
        emailStr.Append(@"</td><td align=""center"" width=""173"" height=""19"">");
        //DBN-5419 => EDT-965
        //emailStr.Append(MakeHeaderStr(masterRow[mMindueamount].ToString().Trim(), true, false));
        emailStr.Append(MakeHeaderStr(masterRow[mCarddafamount].ToString().Trim(), true, false));
        emailStr.Append(@"</td><td align=""center"" width=""161"" height=""19"">");
        emailStr.Append(MakeHeaderStr(basText.formatDate(masterRow[mStetementduedate], "dd/MM/yyyy", 15, "M"), true, false));
        emailStr.Append(@"</td><td align=""center"" width=""140"" height=""19"">");
        ...
        emailStr.Append(@"<tr><td width=""98%"" height=""46%""><br />If we do not receive the minimum payment due by " + basText.formatDate(masterRow[mStetementduedate], "dd/MM/yyyy", 15, "M") + ", you will be charged a late payment fee of NGN 2,000</td></tr>");
        emailStr.Append(@"<tr><td><br /><b>Balance Summary</b></td></tr>");
        //DBN-9168   iatta
        //if (isRewardVal)
        //    {
        ...
        //        emailStr.Append(@"<tr><td width=""99%"">");
        //        emailStr.Append(@"<table id=""table26"" width=""99%"" border=""0"" style=""border-collapse: collapse;height:93""><tr><td>");
        //        emailStr.Append(@"<table id=""table25"" width=""79%"" border=""0"">");
        //        emailStr.Append(@"</tr><tr><td align=""left"" width=""200"" style=""border-style: outset; border-width: 1px"">");
        //        emailStr.Append(MakeHeaderStr("Gem Rewards Opening Balance", false, true));
        //        //emailStr.Append(@"</td><td align=""center"">");
        //        //emailStr.Append(MakeHeaderStr("Qualifying spend this month", true, true);
        //        emailStr.Append(@"</td>");
        //        emailStr.Append(@"<td align=""left"">");
        //        emailStr.Append(MakeHeaderStr(basText.formatNum(rewardRow[mOpeningbalance], "#0.00;(#0.00)", 20, "M"), false, false));
        //        emailStr.Append(@"</td></tr><tr><td align=""left"" width=""103"" style=""border-style: outset; border-width: 1px"">");
        //        emailStr.Append(MakeHeaderStr("Gem Rewards Earned*", false, true));
        //        emailStr.Append(@"</td>");
        //        emailStr.Append(@"</td><td align=""left"">");
        //        emailStr.Append(MakeHeaderStr(basText.formatNum(rewardRow["EARNEDBONUS"], "#0.00;(#0.00)", 20, "M"), false, false));
        //        emailStr.Append(@"</td><tr><td align=""left"" width=""103"" style=""border-style: outset; border-width: 1px"">");
        ...
        //        emailStr.Append(@"</td></tr><tr><td align=""left"" width=""103"" style=""border-style: outset; border-width: 1px"">");
        //        //emailStr.Append(MakeHeaderStr("Gem Rewards Expired Points", false, true));
        //        emailStr.Append(MakeHeaderStr("Expiring Gem Points due " + basText.formatDate(rewardRow["EXPIREDBONUSDATE"], "dd/MM/yyyy", 30, "M"), false, true));
        //        //emailStr.Append(@"</td><td align=""center"" width=""220"" style=""border-style: outset; border-width: 1px"">");
        //        //emailStr.Append(MakeHeaderStr("Date of Expiration", false, true));
        //        //emailStr.Append(MakeHeaderStr("Gem Rewards Expired Date", false, true));
        //        emailStr.Append(@"</td>");
        //        emailStr.Append(@"<td align=""left"">");
        //        emailStr.Append(MakeHeaderStr(basText.formatNum(rewardRow[mExpiredBonusNextMonth], "#0.00;(#0.00)", 20, "M"), false, false));
        //        emailStr.Append(@"</td></tr>");
        ...
        //        //emailStr.Append(@"</td><td align=""center"" width=""220"">");
        //        //emailStr.Append(MakeHeaderStr(basText.formatDate(rewardRow[mExpiredBonusDate], "dd/MM/yyyy", 20, "M"), false, false));
        //        emailStr.Append(@"</td></tr></table></td><td><img style=""height:150px"" width=""641""  border=""0"" alt="""" src=""cid:" + clsBasFile.getFileFromPath(strRewardImg) + @"""><td></tr></table></td></tr>");
        //        emailStr.Append(@"<tr><td width=""98%"" colSpan=""2"">&nbsp;</td></tr>");

        //        //streamWrit.WriteLine(basText.alignmentcenter("RewardOpenBalance", 20) + basText.alignmentcenter("RewardEarnedBonus", 20) + basText.alignmentcenter("RewardRedeemedBonus", 20) + basText.alignmentcenter("RewardClosingBalance", 20));
        ...
        //2
        //emailStr.Append(@"<tr><td width=""98%"" height=""46%"">If we do not receive the minimum payment due by 29/08/2016, you will be charged a late payment fee of NGN 2,000</td></tr>");
        ...
        emailStr.Append(@"<tr><td align=""center"" colSpan=""2"" height=""16"" style=""border-style: outset; border-width: 1px"">");
        emailStr.Append(MakeHeaderStr("Dates of", false, true));
        emailStr.Append(@"</td><td align=""center"" width=""19%"" height=""39"" rowSpan=""2"" style=""border-style: outset; border-width: 1px"">");
        emailStr.Append(MakeHeaderStr("Reference No", true, true));
        emailStr.Append(@"</td><td align=""center"" width=""52%"" colSpan=""2"" height=""39"" rowSpan=""2"" style=""border-style: outset; border-width: 1px"">");
        emailStr.Append(MakeHeaderStr("Description", true, true));
        emailStr.Append(@"</td><td align=""center"" width=""13%"" colSpan=""2"" height=""39"" rowSpan=""2"" style=""border-style: outset; border-width: 1px"">");
        ...
        emailStr.Append(@"<tr><td align=""center"" width=""6%"" height=""19"" style=""border-style: outset; border-width: 1px"">");
        emailStr.Append(MakeHeaderStr("Trans.", false, true));
        emailStr.Append(@"</td><td align=""center"" width=""5%"" height=""19"" style=""border-style: outset; border-width: 1px"">");
    ...
    protected void printDetail()
        ...
        emailStr.Append(@"</td><td width=""42%"" height=""20""><p align=""left"">");
        emailStr.Append(MakeHeaderStr(basText.trimStr(trnsDesc.Trim(), 30), false, false));
        emailStr.Append(@"</td><td align=""right"" width=""10%"" height=""20"">");
    ...
    protected void printCardFooter()
        ...
        emailStr.Append(@"<tr><td width=""99%"" height=""20""><font size=""2"" color=""#000080"">Overview</font></td></tr>");
        emailStr.Append(@"<tr><td width=""100%""><table id=""table22"" width=""100%"" border=""0"" style=""height:64""><tr><td><table id=""table27"" width=""100%"" border=""0"">");
        ...
        emailStr.Append(@"<tr><td width=""98%""><table id=""table24"" width=""79%"" border=""0"">");
        //emailStr.Append(@"<a href=""http://" + strbankWebLink + @""">");
        ...
        emailStr.Append(@"<tr><td align=""center"" width=""106"" style=""border-style: outset; border-width: 1px"">");
        emailStr.Append(MakeHeaderStr("Opening Balance", false, true));
        emailStr.Append(@"</td><td align=""center"" style=""border-style: outset; border-width: 1px"">");
        emailStr.Append(MakeHeaderStr("Payments", false, true));
        emailStr.Append(@"</td><td align=""center"" width=""125"" style=""border-style: outset; border-width: 1px"">");
        emailStr.Append(MakeHeaderStr("Cash & Purchases", false, true));
        emailStr.Append(@"</td><td align=""center"" width=""55"" style=""border-style: outset; border-width: 1px"">");
        emailStr.Append(MakeHeaderStr("Interest", false, true));
        emailStr.Append(@"</td><td align=""center"" width=""51"" style=""border-style: outset; border-width: 1px"">");
        emailStr.Append(MakeHeaderStr("Charges", false, true));
        emailStr.Append(@"</td><td align=""center"" width=""118"" style=""border-style: outset; border-width: 1px"">");
        emailStr.Append(MakeHeaderStr("Closing Balance", true, true));
        emailStr.Append(@"</td><td align=""center"" width=""89"" style=""border-style: outset; border-width: 1px"">");
        emailStr.Append(MakeHeaderStr("Total Debit(s)", false, true));
        emailStr.Append(@"</td><td align=""center"" width=""97"" style=""border-style: outset; border-width: 1px"">");
        emailStr.Append(MakeHeaderStr("Total Credit(s)", false, true));
        emailStr.Append(@"</td></tr>");

        emailStr.Append(@"<tr><td align=""center"" width=""106"">");
        ...
        emailStr.Append(@"</td><td align=""center"" width=""127"">");
        ...
        emailStr.Append(@"</td><td align=""center"" width=""57"">");
        ...
        emailStr.Append(@"</td><td align=""center"" width=""53"">");
        ...
        emailStr.Append(@"</td><td align=""center"" width=""120"">");
        ...
        //        rewardRow = rewardRows[0];
        //        //emailStr.Append(@"<tr><td width=""98%"" colSpan=""2""><table id=""table25"" width=""100%"" border=""0"">");
        //        emailStr.Append(@"<tr><td width=""98%"" colSpan=""2""><table id=""table25"" width=""79%"" border=""0"">");
        //        emailStr.Append(@"<tr><td align=""center"" width=""220"" style=""border-style: outset; border-width: 1px"">");
        //        emailStr.Append(MakeHeaderStr("Gem Rewards Opening Balance", false, true));
        //        //emailStr.Append(@"</td><td align=""center"">");
        //        //emailStr.Append(MakeHeaderStr("Qualifying spend this month", true, true);
        //        emailStr.Append(@"</td><td align=""center"" width=""200"" style=""border-style: outset; border-width: 1px"">");
        ...
        //        emailStr.Append(@"<tr><td align=""center"" width=""220"">");
        //        emailStr.Append(MakeHeaderStr(basText.formatNum(rewardRow[mOpeningbalance], "#0.00;(#0.00)", 20, "M"), false, false));
        //        //emailStr.Append(@"</td><td align=""center"">");
        //        //emailStr.Append(MakeHeaderStr("0", false, false);
        //        emailStr.Append(@"</td><td align=""center"" width=""200"">");
        //        emailStr.Append(MakeHeaderStr(basText.formatNum(rewardRow["EARNEDBONUS"], "#0.00;(#0.00)", 20, "M"), false, false));
        //        emailStr.Append(@"</td><td align=""center"" width=""200"">");
        //        emailStr.Append(MakeHeaderStr(basText.formatNum(rewardRow["REDEEMEDBONUS"], "#0.00;(#0.00)", 20, "M"), false, false));
        //        emailStr.Append(@"</td><td align=""center"" width=""220"">");
        ...
        //DBN-6190 EDT-1140 EDT-1616
        //emailStr.Append(@"<tr><td width=""98%""><table id=""table26"" width=""79%"" border=""0"">");
        //emailStr.Append(@"<tr><td align=""middle"" width=""220"" style=""border-style: outset; border-width: 1px"">");
        //emailStr.Append(MakeHeaderStr("Available International Spend Limit", false, true));
        //emailStr.Append(@"</td></tr>");

        //emailStr.Append(@"<tr><td align=""middle"" width=""220"">");
        //emailStr.Append(MakeHeaderStr(basText.formatNum(masterRow[mIntSpentLimit].ToString(), "#0.00;(#0.00)", 20, "M"), false, false));
        //emailStr.Append(@"</td></tr></table></td></tr>");
        //emailStr.Append(@"<tr><td width=""98%"" colSpan=""2"">&nbsp;</td></tr>");

        //emailStr.Append(@"<tr><td width=""98%"" colSpan=""2"">&nbsp;</td></tr>");
        emailStr.Append(@"<tr><td width=""98%"" colSpan=""2"">&nbsp;");

        //emailStr.Append(@"<a href=""http://" + strbankWebLink + @""">");
        //emailStr.Append(@"<img border=""0"" alt="""" src=""cid:" + clsBasFile.getFileFromPath(strBankMidBanner) + @"""></a></table><table id=""table26"" width=""100%"" border=""0"">");

        emailStr.Append(@"<p align=""" + logoAlignmentStr + @""">");
        emailStr.Append(@"<a href=""http://" + strbankWebLink + @""">");
        emailStr.Append(@"<img border=""0"" alt="""" src=""cid:" + clsBasFile.getFileFromPath(strBankMidBanner) + @"""/></a></td></tr></table><table id=""table26"" width=""100%"" border=""0"">");// width=""230"" height=""85""
        ...
        //emailStr.Append(@"<a href=""http://" + strbankWebLink + @""">");
        //emailStr.Append(@"<img border=""0"" alt="""" src=""cid:" + clsBasFile.getFileFromPath(strBankBottomBanner) + @"""></a></td></tr>");

        emailStr.Append(@"<tr><td width=""98%""><p align=""" + logoAlignmentStr + @""">");
        // emailStr.Append(@"<a href=""http://" + strbankWebLink + @""">");
        //emailStr.Append(@"<b><p>Diamond Bank GEM Rewards/Partners</p></b>");
        ...
        if (isRewardVal)
            ...
            if (rewardRows.Length > 0)
                ...
                //emailStr.Append(@"<table id=""table25"" width=""79%"" border=""0"">");
                //emailStr.Append(@"</tr><tr><td align=""left"" width=""200"" style=""border-style: outset; border-width: 1px"">");
                //emailStr.Append(MakeHeaderStr("Opening Bal", false, true));
                //DBN - 11224
                ...
                //emailStr.Append(MakeHeaderStr("Gem Rewards Expired Points", false, true));
                 ...
                 //DBN - 11224
                //emailStr.Append(MakeHeaderStr("Number of Gem Points due to expire " + basText.formatDate(rewardRow["EXPIREDBONUSDATE"], "dd/MM/yyyy", 30, "M"), false, true));
                //DBN - 11224
                ...
                //emailStr.Append(@"<tr><td width=""98%"" colSpan=""2"">");
                //emailStr.Append(@"<br>");
                //emailStr.Append(@"<p>You can redeem points earned with any of our partner merchants. For more information on how to redeem, visit <a title="" +strbankWebLink+"" href=""http://" + strbankWebLink + @""">" + strbankWebLink + @"</a>;<br> Support & Services, go to Cards, and click on Gem Redemption Partners</p>");
                //emailStr.Append(@"<br>");
                //emailStr.Append(@"</td></tr>");
                ...
                //emailStr.Append(@"<tr><td width=""98%"" colSpan=""2""><font size=""2"">* Please save these numbers on your mobile phone, to contact us 24/7:01 - 6283892 and 01 - 2793500</font></td></tr>");
                //emailStr.Append(@"<br/>");
                //emailStr.Append(@"<tr><td width=""98%"" colSpan=""6"" style=""background-color:Gray"">To redeem your points with any of our partners, kindly send a mail to <a>cards@diamondbank.com</a> stating the name of the partner and the number of Gem points to be redeemed. For more information on how to redeem, visit <a>www.DiamondBank.com</a>; Support & Services, go to Cards, and click on Gem Redemption Partners</td>");
                //emailStr.Append(@"<br/>");
                }
            }
        ...
        //emailStr.Append(@"<tr><td width='98%' colSpan='2'><p align='center'><img border='0' src='cid:" + clsBasFile.getFileFromPath(bottomBanner) + @"'></a></td></tr>");
        //emailStr.Append(@"<br/>");
        //emailStr.Append(@"<tr><td width=""98%"" colSpan=""6"" style=""background-color:Gray"">To redeem your points with any of our partners, kindly send a mail to <a>cards@diamondbank.com</a> stating the name of the partner and the number of Gem points to be redeemed. For more information on how to redeem, visit <a>www.DiamondBank.com</a>; Support & Services, go to Cards, and click on Gem Redemption Partners</td>");
        //emailStr.Append(@"<br/>");
        emailStr.Append(@"<tr><td width=""98%"" colSpan=""6"">");
        emailStr.Append(@"<a href=""https://gemzone.diamondbank.com/"">");
        emailStr.Append(@"<img border=""0"" alt="""" src=""cid:" + clsBasFile.getFileFromPath(strBankBottomBanner) + @"""/></a></td></tr>");// width=""230"" height=""85""
        ...
        //emailStr.Append(@"<tr><td width=""98%"" colSpan=""6"">");
        //emailStr.Append(@"<p>For enquiries, call our 24hour Contact Centre on 07003000000, send an SMS to 30811 or an email to <a>enquiries@diamondbank.com</a>.<br> To offer feedback or make a complaint, please send an email to <a>complaints@diamondbank.com</a></p>");
        //emailStr.Append(@"</td></tr>");
    ...
    private void calcAccountRows()
        ...
        foreach (DataRow mainRow in mainRows) //mRow.GetChildRows(StatementNoDRel)
            ...
            //IntSpentLimit = int.Parse(mainRow[mIntSpentLimit].ToString());
            //intspentlimitMain = IntSpentLimit;
    ...
    private void SendEmail(string pBody, string pSubject, string pTo)
        ...
        if (valdEmail.isValideEmail(pTo) != "ValidEmail")
            {
                if (pTo.EndsWith("@intercontinentalbankplc"))
                    pTo = pTo + ".com";
                else
                {
        ...
        //streamEmails.WriteLine(curAccountNumber + "|" + curClientID + "|" + pTo + "|" + DateTime.Now.ToString("yyyy/MM/dd HH:mm:ss"));
            ...
            pLstAttachedFile.Add(strBankBottomBanner);
            if (strBankCard != null)
                {
                pLstAttachedFile.Add(strBankCard);
                }
            if (strBankCardGold != null && strBankCardPlatinum != null)
                {
                pLstAttachedFile.Add(strBankCardGold);
                pLstAttachedFile.Add(strBankCardPlatinum);
                }
            pLstAttachedFile.Add(strRewardImg); //strOutputFile@"D:\Web\Email\BAI\Logo.gif"
            ...
            if (numMail == 0)
                {
                //pLstBCC.Add("mali@emp-group.com");
    ...
    public string bankCard
        {
        get { return strBankCard; }
        set { strBankCard = value; }
        }// bankCard

    public string RewardLogo
        {
        get { return strRewardImg; }
        set { strRewardImg = value; }
        }// bankCard
    ...
    public string bankCardGold
        {
        get { return strBankCardGold; }
        set { strBankCardGold = value; }
        }// bankCardGold

    public string bankCardPlatinum
        {
        get { return strBankCardPlatinum; }
        set { strBankCardPlatinum = value; }
        }// bankCardPlatinum

    ~clsStatementDBN_Html_New()
        {
        DSstatement.Dispose();
        }
    }
