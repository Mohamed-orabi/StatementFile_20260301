...
// Branch X
public class clsStatRawData_UNB : clsBasStatement
{
    ...
    public string Statement(string pStrFileName, DataSet pDSstatement)
    {
        try
        {
            ...
            string strFileHeader = "CardHolder Name" + fldSprtr + "Address1" + fldSprtr + "Address2" + fldSprtr + "Address3" +
              ...
              fldSprtr + "Purch.Cash&Dr" + fldSprtr + "Finance Charge" + fldSprtr + "External NO" + fldSprtr
              + "Card Primary" + fldSprtr + "Primary Card NO" + fldSprtr;//+ fldSprtr + "Pages" 
