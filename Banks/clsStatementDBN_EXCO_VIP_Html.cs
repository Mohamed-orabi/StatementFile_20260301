...
public class clsStatementDBN_EXCO_VIP_Html : clsBasStatement
    {
    ...
    public clsStatementDBN_EXCO_VIP_Html()
        {
        }
    ...
    public string Statement(string pStrFileName, string pBankName, int pBankCode, string pStrFile, DateTime pCurDate, string pStmntType, bool pAppendData)
        ...
        try
            ...
            emailLabel = "VISA EXCO VIP" + " Statement for " + vCurDate.ToString("MM/yyyy"); //"BAI statement for 02/2008"
            ...
            //if (clsBasFile.getFileWithoutExtn(pStrFileName).StartsWith("DBN_EXCO_VIP_ClientsEmails"))
            //{
    ...
    protected void printHeader()
        ...
        emailStr.Append(@"<img border=""0"" src=""cid:" + clsBasFile.getFileFromPath(strBankLogo) + @"""></a></td></tr>");//<img border='0' src='cid:" + clsBasFile.getFileFromPath(bottomBanner) + @"'></a></td></tr>");// width=""230"" height=""85""
    ...
    protected void printCardFooter()
        ...
        //emailStr.Append(@"<font size=""2"">Please save these numbers on your mobile phone, to contact us 24/7:07003000000</font>");
    ...
    private void SendEmail(string pBody, string pSubject, string pTo)
        ...
        //streamEmails.WriteLine(curAccountNumber + "|" + curClientID + "|" + pTo + "|" + DateTime.Now.ToString("yyyy/MM/dd HH:mm:ss"));
            ...
            //{
            //    strEmailFromTmp = "statement@emp-group.com";
            //}
            if (numMail == 0)
                {
                //pLstBCC.Add("mmohammed@emp-group.com");
