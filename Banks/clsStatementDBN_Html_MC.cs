...
public class clsStatementDBN_Html_MC : clsBasStatement
    {
    ...
    public clsStatementDBN_Html_MC()
        {
        }
    ...
    public string Statement(string pStrFileName, string pBankName, int pBankCode, string pStrFile, DateTime pCurDate, string pStmntType, bool pAppendData)
        ...
        try
            ...
            //emailLabel = "Wakanow MasterCard Credit card Statement for " + vCurDate.ToString("MM/yyyy");
            //DBN-5403 Change of Statement Label
            //emailLabel = "Diamond Wakanow Statement for " + vCurDate.ToString("MM/yyyy");
