...
// Branch 14
public class clsStatementBIC : clsBasStatement
{
  ...
  public string Statement(string pStrFileName, string pBankName, int pBankCode, string pStrFile, DateTime pCurDate, string pStmntType, bool pAppendData)
  {
    ...
    try
    {
      ...
      // set branch for data
      curBranchVal = pBankCode; // 14; //3 = real   1 = test
      ...
      // data retrieve
      FillStatementDataSet(pBankCode); //DSstatement =  //14); //3
