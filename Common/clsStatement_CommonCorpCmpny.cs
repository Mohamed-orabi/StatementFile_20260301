...
// Branch 1
public class clsStatement_CommonCorpCmpny : clsBasStatement
{
  ...
  public clsStatement_CommonCorpCmpny()
  {
  }
  ...
  private void printCompanyStatement()
  {
    ...
    try
    {
      ...
      foreach (DataRow contractRow in DSstatement.Tables["contractTable"].Rows)
      {
        ...
        CurrentPageFlag = string.Empty;
        prevAccountNo = contractRow[mContractno].ToString(); //>masterRow[mCardaccountno].ToString()
  ...
  private void printDetailCompany()
  {
    ...
    //
    mainRows = DSstatement.Tables["tStatementMasterTable"].Select(mCardaccountno + " = '" + strStatementNo + "'");
